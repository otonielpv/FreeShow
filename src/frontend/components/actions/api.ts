...
export type API_slide_thumbnail = { showId?: string; layoutId?: string; index?: number; scale?: number }
export type API_seek = { id?: string; seconds: number }
export type API_media = { path: string; index?: number; data?: any; size?: number }
